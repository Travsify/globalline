...
@section('content')
    ...
    <header class="pt-48 pb-24 bg-brand-navy relative overflow-hidden text-center">
        ...
        <div class="container mx-auto px-6 relative z-10">
            <span class="inline-block px-4 py-1 bg-brand-gold/10 text-brand-gold rounded-full mb-6 italic platform-label">Help Center</span>
    ...
    <section class="py-32 bg-white" x-data="{ active: null }">
        <div class="container mx-auto px-6 max-w-4xl">
            ...
            <div class="space-y-16">
                <!-- Group 1: Logistics -->
                <div>
                    <h4 class="text-brand-navy mb-8 border-l-4 border-brand-gold pl-4 italic platform-label">Logistics & Shipping</h4>
                    <div class="space-y-4">
                        <!-- Q1 -->
                        <div class="border border-slate-100 rounded-2xl overflow-hidden transition-soft" :class="active === 1 ? 'shadow-xl border-brand-gold/30' : ''">
                            ...
                            <div x-show="active === 1" x-collapse>
                                <div class="px-8 pb-8 text-slate-500 leading-relaxed platform-body">
                ...
                <!-- Group 2: Sourcing -->
                <div>
                    <h4 class="text-brand-navy mb-8 border-l-4 border-brand-gold pl-4 italic platform-label">Sourcing & Suppliers</h4>
                    <div class="space-y-4">
                        <!-- Q3 -->
                ...
                <!-- Group 3: Financial -->
                <div>
                    <h4 class="text-brand-navy mb-8 border-l-4 border-brand-gold pl-4 italic platform-label">Payments & Wallets</h4>
                    <div class="space-y-4">
                        <!-- Q4 -->

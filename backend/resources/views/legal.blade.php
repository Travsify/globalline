...
@section('content')
    ...
    <header class="pt-48 pb-24 bg-brand-navy relative overflow-hidden">
        ...
        <div class="container mx-auto px-6 relative z-10 text-center">
            <span class="inline-block px-4 py-1 bg-white/5 text-white/40 border border-white/10 rounded-full text-[10px] font-black uppercase tracking-[0.3em] mb-6 italic">Protocol Governance</span>
            ...
            <p class="text-xl text-white/30 max-w-2xl mx-auto leading-relaxed">
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="flex flex-wrap gap-4 mb-20 border-b border-slate-100 pb-8">
                    <button @click="tab = 'terms'" 
                            ...
                            class="px-8 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all italic">
                        Terms of Engagement
                    </button>
                ...
                <div x-show="tab === 'terms'" x-cloak class="prose prose-slate max-w-none">
                    ...
                    <p class="text-slate-500 mb-6">Last Updated: February 2026</p>
                    <p class="text-slate-500 leading-relaxed mb-6">By using the GlobalLine terminal, you enter into a binding agreement for the facilitation of global sourcing and logistics. GlobalLine acts as a technology bridge between you and verified global manufacturers.</p>
                    <h4 class="text-brand-navy font-black uppercase italic tracking-widest text-sm mb-4">1. Sourcing Protocols</h4>
                    ...
                    <h4 class="text-brand-navy font-black uppercase italic tracking-widest text-sm mb-4">2. Payment Settlements</h4>
                ...
                <div x-show="tab === 'privacy'" x-cloak class="prose prose-slate max-w-none">
                    ...
                    <p class="text-slate-500 mb-6">We protect your trade secrets and business data with enterprise-grade encryption.</p>
                    <p class="text-slate-500 leading-relaxed mb-8">Your procurement history, factory listings, and transit data are strictly confidential and encrypted at the node level. We do not sell trade data to third parties.</p>
                </div>
                ...
                <div x-show="tab === 'compliance'" x-cloak class="prose prose-slate max-w-none">
                    ...
                    <p class="text-slate-500 leading-relaxed mb-8">GlobalLine adheres strictly to AML (Anti-Money Laundering) and KYC (Know Your Customer) regulations in every jurisdiction we operate.</p>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div class="p-8 bg-slate-50 rounded-3xl">
                            <h5 class="font-black text-brand-navy uppercase italic tracking-widest text-xs mb-4">China Hub</h5>
                            <p class="text-xs text-slate-500">Compliance with PRC export and trade manufacturing regulations.</p>
                        </div>
                        <div class="p-8 bg-slate-50 rounded-3xl">
                            <h5 class="font-black text-brand-navy uppercase italic tracking-widest text-xs mb-4">Africa Hub</h5>
                            <p class="text-xs text-slate-500">Customs and clearing compliance across West and East Africa (Nigeria, Kenya, Ghana).</p>
                        </div>
                    </div>
                </div>
            </div>

...
@section('content')
    ...
    <section class="relative pt-32 pb-20 bg-navy-dark overflow-hidden">
        ...
        <div class="container mx-auto px-6 relative z-10 text-center">
            <span class="text-amber-brand font-bold uppercase tracking-[0.3em] text-xs mb-6 block" data-aos="fade-up">Transparent Pricing</span>
        ...
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                ...
                <div class="bg-white p-8 rounded-[2rem] border border-slate-200 shadow-xl hover:shadow-2xl hover:border-amber-brand/30 transition-all duration-300 relative group" data-aos="fade-up">
                    <div class="mb-8">
                        <span class="bg-navy-light/10 text-navy-dark px-4 py-2 rounded-lg text-[10px] font-bold uppercase tracking-widest">Economy</span>
                        ...
                        <p class="text-slate-500 text-sm mt-4 leading-relaxed">Best for non-urgent shipments. Reliable delivery within a week.</p>
                    </div>
                ...
                <div class="bg-navy-dark p-8 rounded-[2rem] shadow-2xl overflow-hidden relative group transform lg:-translate-y-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="absolute top-0 right-0 bg-amber-brand text-navy-dark px-4 py-2 rounded-bl-2xl text-[10px] font-bold uppercase tracking-widest">Most Popular</div>
                    <div class="absolute inset-0 bg-gradient-to-b from-navy-light/50 to-navy-dark z-0"></div>
                    
                    <div class="relative z-10">
                        <div class="mb-8">
                             <span class="bg-white/10 text-amber-brand px-4 py-2 rounded-lg text-[10px] font-bold uppercase tracking-widest">Express</span>
                            ...
                            <p class="text-white/60 text-sm mt-4 leading-relaxed">For fast, time-sensitive cargo. Delivery in specific time windows.</p>
                        </div>

                        <ul class="space-y-4 mb-8 text-sm text-white/80">
                            <li class="flex items-center gap-3">
                        ...
                        <a href="{{ route('register') }}" class="block w-full text-center py-4 rounded-xl bg-amber-brand font-bold uppercase tracking-widest text-xs text-navy-dark hover:bg-white transition-colors">
                            Get Rates
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-white p-8 rounded-[2rem] border border-slate-200 shadow-xl hover:shadow-2xl hover:border-amber-brand/30 transition-all duration-300 relative group" data-aos="fade-up" data-aos-delay="200">
                    <div class="mb-8">
                        <span class="bg-navy-light/10 text-navy-dark px-4 py-2 rounded-lg text-[10px] font-bold uppercase tracking-widest">Volume</span>
                        ...
                        <p class="text-slate-500 text-sm mt-4 leading-relaxed">Ideal for heavy or bulky items. Optimized for volume cost savings.</p>
                    </div>

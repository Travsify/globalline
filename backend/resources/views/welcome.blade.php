...
@section('content')
        ...
        <div class="swiper heroSwiper h-full">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide relative flex items-center pt-32 pb-20 overflow-hidden">
                    ...
                    <div class="container mx-auto px-6 relative z-20">
                        <div class="max-w-4xl" data-aos="fade-right">
                            <span class="inline-block px-4 py-2 bg-amber-brand/10 border border-amber-brand/20 rounded-full text-amber-brand platform-label mb-8">Infrastructure_Alpha</span>
                            ...
                            <p class="text-white/50 mb-12 max-w-2xl leading-relaxed italic border-l-4 border-amber-brand pl-8 platform-body">
                ...
                <div class="swiper-slide relative flex items-center pt-32 pb-20 overflow-hidden">
                    ...
                    <div class="container mx-auto px-6 relative z-20">
                        <div class="max-w-4xl">
                            <span class="inline-block px-4 py-2 bg-blue-500/10 border border-blue-500/20 rounded-full text-blue-400 platform-label mb-8">Direct_Access_v5</span>
                            <h1 class="text-6xl md:text-8xl font-bold font-heading text-white leading-[0.85] mb-8 tracking-tighter">
                                Factory. <br><span class="italic text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-white">Direct.</span>
                            </h1>
                            <p class="text-white/50 mb-12 max-w-2xl leading-relaxed italic border-l-4 border-blue-500 pl-8 platform-body">
                ...
                <div class="swiper-slide relative flex items-center pt-32 pb-20 overflow-hidden">
                    ...
                    <div class="container mx-auto px-6 relative z-20">
                        <div class="max-w-4xl">
                            <span class="inline-block px-4 py-2 bg-emerald-500/10 border border-emerald-500/20 rounded-full text-emerald-400 platform-label mb-8">Capital_Rail_0x</span>
                            <h1 class="text-6xl md:text-8xl font-bold font-heading text-white leading-[0.85] mb-8 tracking-tighter">
                            ...
                            <p class="text-white/50 mb-12 max-w-2xl leading-relaxed italic border-l-4 border-emerald-500 pl-8 platform-body">
        ...
        <div class="absolute bottom-0 left-1/2 -translate-x-1/2 z-40 w-full container px-6 translate-y-1/2 hidden lg:block">
            <div class="bg-white rounded-[3rem] shadow-4xl p-10 flex items-center gap-12 border border-slate-100 backdrop-blur-xl bg-white/95" x-data="{ activeTab: 'track' }">
                ...
                <div class="w-1/4 pr-12 border-r border-slate-100">
                    ...
                    <p class="text-slate-400 platform-label">Execute instant actions below.</p>
                </div>

                <div class="flex-1 flex items-center gap-8">
                    <!-- Tabs -->
                    <div class="flex flex-col gap-2">
                        <button @click="activeTab = 'track'" :class="activeTab === 'track' ? 'bg-navy-dark text-white' : 'text-slate-400 hover:bg-slate-50'" class="px-6 py-3 rounded-xl transition-all platform-label">Quick_Track</button>
                        <button @click="activeTab = 'calc'" :class="activeTab === 'calc' ? 'bg-navy-dark text-white' : 'text-slate-400 hover:bg-slate-50'" class="px-6 py-3 rounded-xl transition-all platform-label">Cost_Engine</button>
                    </div>

                    <!-- Tab Content: Track -->
                    <div x-show="activeTab === 'track'" class="flex-1" x-transition>
                        <form action="{{ route('tracking') }}" method="GET" class="flex gap-4">
                            <input type="text" name="tracking_id" class="flex-1 bg-slate-50 border-2 border-slate-100 rounded-2xl px-8 py-5 text-navy-dark focus:outline-none focus:border-amber-brand transition-all italic platform-body" placeholder="Enter Global Node ID (e.g. GL-77X-2026)">
                            <button type="submit" class="bg-amber-brand hover:bg-navy-dark hover:text-white px-8 py-5 rounded-2xl transition-all group platform-label">
                                Trace Node &rarr;
                            </button>
                        </form>
                    </div>
                    ...
                    <div x-show="activeTab === 'calc'" class="flex-1 flex items-center gap-12" x-transition>
                        <div class="flex-1">
                            <label class="block text-slate-400 mb-4 platform-label">Payload_Volume (KG)</label>
                        ...
                        <div class="shrink-0 text-center">
                            <p class="text-slate-300 italic mb-1 platform-label">Estimated Cost</p>
                            <div class="text-3xl font-black text-navy-dark italic leading-none">$1,240.00*</div>
                        </div>
                        <a href="{{ route('calculator') }}" class="bg-navy-dark text-white px-8 py-5 rounded-2xl hover:bg-amber-brand hover:text-navy-dark transition-all platform-label">
                            Full Estimate
                        </a>
                    </div>
                </div>
        ...
        <div class="container mx-auto px-6">
            <div class="flex flex-col lg:flex-row items-center gap-20">
                <div class="lg:w-1/2" data-aos="fade-right">
                    <span class="text-amber-brand mb-6 block platform-label">Backbone_Protocol</span>
                    ...
                    <p class="text-white/50 mb-12 leading-relaxed platform-body">
                    ...
                    <div class="relative bg-white/5 border border-white/10 rounded-[4rem] p-12 backdrop-blur-3xl overflow-hidden group">
                        ...
                        <div class="absolute bottom-16 left-16 right-16 bg-navy-dark/90 backdrop-blur-xl border border-white/10 p-8 rounded-3xl translate-y-8 group-hover:translate-y-0 transition-transform">
                            <div class="flex items-center gap-4 mb-4">
                                ...
                                <span class="text-white/50 platform-label">Node_Stream: Live</span>
                            </div>
        ...
        <div class="container mx-auto px-6">
            <div class="flex flex-col md:flex-row items-center gap-16">
                         ...
                         <div class="relative z-10 text-white">
                             <div class="flex justify-between items-center mb-10">
                                 <div class="flex items-center gap-4">
                                     ...
                                     <div>
                                         <p class="text-white/30 italic platform-label">Transaction_ID</p>
                                         <p class="font-bold text-xl tracking-tight italic">GL_SETTLE_0x92</p>
                                     </div>
                                 </div>
                                 <div class="text-right">
                                     <p class="text-white/30 italic platform-label">Status</p>
                                     <p class="text-emerald-400 font-black italic platform-body">VERIFIED</p>
                                 </div>
                             </div>
                ...
                <div class="md:w-1/2" data-aos="fade-left">
                    <span class="text-amber-brand mb-6 block platform-label">Settlement_Rails</span>
                    ...
                    <p class="text-slate-500 leading-relaxed mb-10 italic border-l-4 border-slate-100 pl-8 platform-body">
                    ...
                    <ul class="space-y-6 mb-12">
                        <li class="flex items-center gap-5">
                            ...
                            <span class="text-navy-dark tracking-tight platform-body">Instant Node-to-Node Settlements</span>
                        </li>
                        <li class="flex items-center gap-5">
                            <div class="w-8 h-8 rounded-xl bg-emerald-500/10 flex items-center justify-center text-emerald-500">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"></path></svg>
                            </div>
                            <span class="text-navy-dark tracking-tight platform-body">Zero-Threshold FX Latency</span>
                        </li>
                    </ul>
                    <a href="{{ route('register') }}" class="group inline-flex items-center gap-4 text-navy-dark border-b-4 border-amber-brand pb-2 hover:text-amber-brand transition-colors platform-label">
    ...
    <section class="py-32 bg-slate-50 relative overflow-hidden">
        <div class="container mx-auto px-6">
            <div class="text-center mb-24 max-w-3xl mx-auto" data-aos="fade-up">
                 <span class="text-blue-600 block mb-6 platform-label">Supply_Chain_v2</span>
                 ...
                 <p class="italic platform-body text-slate-400">Bypass intermediaries. Access physical manufacturing clusters directly via GlobalLine.</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="md:col-span-2 bg-white rounded-[3.5rem] p-16 shadow-2xl border border-slate-100 group hover:shadow-4xl transition-all duration-500" data-aos="fade-up">
                    <div class="flex flex-col md:flex-row justify-between items-start gap-12">
                        ...
                        <div class="bg-emerald-50 text-emerald-600 px-6 py-3 rounded-full self-start border border-emerald-100 platform-label">Audit_Cleared</div>
                    </div>
                </div>
                ...
                <div class="bg-navy-dark rounded-[3.5rem] p-16 shadow-2xl text-white group hover:shadow-4xl transition-all duration-500" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p class="text-white/40 italic leading-relaxed platform-body">Our local sourcing teams leverage cluster-volume to slash procurement costs by an average of 20%.</p>
                </div>
                ...
                <div class="bg-white rounded-[3.5rem] p-12 shadow-2xl border border-slate-100 group hover:bg-navy-dark hover:text-white transition-all duration-500" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <p class="text-slate-400 italic leading-relaxed group-hover:text-white/40 platform-body">Fuse samples from multiple factory nodes into a single high-velocity shipment. Reduce payload redundancy.</p>
                </div>
        ...
        <div class="container mx-auto px-6">
            <div class="flex flex-col lg:flex-row gap-20">
                <div class="lg:w-1/3" data-aos="fade-right">
                    <span class="text-amber-brand mb-6 block platform-label">Buffer_Nodes</span>
                    ...
                    <p class="leading-relaxed italic border-l-4 border-slate-100 pl-8 mb-12 text-slate-500 platform-body">
                        Store payload at our global hubs for 30 days at zero cost. Re-route and consolidate instantly to optimize spatial freight.
                    </p>
                    <a href="{{ route('network') }}" class="text-navy-dark border-b-4 border-blue-500 pb-2 hover:text-blue-500 transition-colors platform-label">Surface Hub Metadata &rarr;</a>
                </div>
                <div class="lg:w-2/3" data-aos="fade-left">
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                        ...
                        <div class="bg-slate-50 rounded-[2.5rem] p-10 text-center hover:bg-navy-dark hover:text-white transition-all duration-500 border border-slate-100 group shadow-lg hover:shadow-4xl">
                            ...
                            <p class="uppercase text-slate-400 group-hover:text-white/20 platform-label">Lagos</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container mx-auto px-6">
            <div class="bg-gradient-to-br from-navy to-navy-dark rounded-[4rem] p-16 md:p-24 relative overflow-hidden text-center border border-white/5 shadow-4xl shadow-navy-dark/50">
                ...
                <div class="relative z-10 max-w-4xl mx-auto py-10">
                    <span class="text-amber-brand block mb-8 platform-label">Sales_Relay</span>
                    ...
                    <p class="mb-16 leading-relaxed italic text-white/40 platform-body">
                    ...
                    <div class="flex justify-center flex-wrap gap-6 mb-16">
                         <div class="bg-white/5 px-8 py-4 rounded-2xl border border-white/5 backdrop-blur-md platform-label">Shopify_API</div>
                         <div class="bg-white/5 px-8 py-4 rounded-2xl border border-white/5 backdrop-blur-md platform-label">Woo_Module</div>
                         <div class="bg-white/5 px-8 py-4 rounded-2xl border border-white/5 backdrop-blur-md platform-label">Wix_Engine</div>
                    </div>

                    <a href="{{ route('register') }}" class="group bg-white text-navy-dark px-16 py-6 rounded-3xl hover:bg-amber-brand transition-all shadow-btn active:scale-95 italic border-2 border-transparent platform-label">
        ...
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                ...
                <div class="p-16 rounded-[3.5rem] border-2 border-slate-100 bg-slate-50 hover:bg-white hover:border-emerald-500/20 hover:shadow-4xl transition-all duration-500 group" data-aos="fade-up">
                    ...
                    <p class="text-slate-500 leading-relaxed italic platform-body">Real-time GPS telemetry for every container and pallet node. Full trajectory transparency.</p>
                </div>
                ...
                <div class="p-16 rounded-[3.5rem] border-2 border-slate-100 bg-slate-50 hover:bg-white hover:border-amber-brand/20 hover:shadow-4xl transition-all duration-500 group" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p class="text-slate-500 leading-relaxed italic platform-body">Full-stack insurance protocol. Lost or damaged nodes are refunded at 100% face value instantly.</p>
                </div>
                ...
                <div class="p-16 rounded-[3.5rem] border-2 border-slate-100 bg-slate-50 hover:bg-white hover:border-blue-500/20 hover:shadow-4xl transition-all duration-500 group" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <span class="px-5 py-2 rounded-xl bg-white border border-slate-200 text-slate-400 group-hover:border-blue-500 group-hover:text-blue-500 transition-colors platform-label">Medical</span>
                        <span class="px-5 py-2 rounded-xl bg-white border border-slate-200 text-slate-400 group-hover:border-blue-500 group-hover:text-blue-500 transition-colors platform-label">Industrial</span>
                        <span class="px-5 py-2 rounded-xl bg-white border border-slate-200 text-slate-400 group-hover:border-blue-500 group-hover:text-blue-500 transition-colors platform-label">Tech_Nodes</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-40 bg-navy-dark relative overflow-hidden text-center border-t border-white/5">
        ...
        <div class="container mx-auto px-6 relative z-10">
            ...
            <p class="text-white/40 mb-20 max-w-3xl mx-auto italic leading-relaxed platform-body">
            ...
            <div class="flex flex-col sm:flex-row justify-center items-center gap-8">
                 <a href="{{ route('register') }}" class="group flex items-center gap-6 bg-white text-navy-dark px-12 py-8 rounded-[2.5rem] font-bold transition-all hover:bg-slate-200 active:scale-95 shadow-btn">
                    <svg class="w-10 h-10" viewBox="0 0 24 24" fill="currentColor"><path d="M17.061 11.22c-.063-2.583 2.115-3.854 2.208-3.905-1.2-1.761-3.076-2.002-3.739-2.025-1.579-.163-3.078.932-3.878.932-.803 0-2.096-.913-3.465-.892-1.78.026-3.431 1.036-4.349 2.637-1.857 3.218-.475 7.952 1.332 10.552.89 1.282 1.948 2.709 3.056 2.686 1.226-.051 1.693-.794 3.176-.794 1.481 0 1.903.794 3.197.771 1.32-.051 2.164-1.203 2.972-2.392.936-1.369 1.323-2.693 1.346-2.766-.026-.013-2.583-.989-2.659-3.926M14.986 5.253c.691-.836 1.157-1.996 1.026-3.153-1.002.041-2.217.658-2.936 1.498-.638.74-1.196 1.921-1.047 3.048 1.127.086 2.273-.559 2.957-1.393"/></svg>
                     <div class="text-left leading-tight">
                         <div class="text-navy-dark/40 italic platform-label">Available on</div>
                ...
                <a href="{{ route('register') }}" class="group flex items-center gap-6 bg-white/5 text-white border-2 border-white/10 px-12 py-8 rounded-[2.5rem] font-bold backdrop-blur-md transition-all hover:bg-white/10 active:scale-95 shadow-btn">
                    <svg class="w-10 h-10" viewBox="0 0 24 24" fill="currentColor"><path d="M3.609 1.814L13.792 12 3.61 22.186a.996.996 0 01-.61-.92V2.734a1 1 0 01.609-.92zm4.72 10.22l7.76-4.305-3.326-1.89-4.434 6.195zm4.814 1.353l-2.043-1.133L9.666 18.5 13.143 13.387zm1.385-2.067l4.137 2.296a1.001 1.001 0 010 1.754l-4.137 2.296L14.075 12 14.528 11.32z"/></svg>
                     <div class="text-left leading-tight">
                         <div class="text-white/30 italic platform-label">Available on</div>
